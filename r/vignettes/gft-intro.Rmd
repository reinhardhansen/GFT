...
(2026): matrix-free inexact Newton steps for the residual
$\log\mathrm{diag}(e^{A})$, solved by preconditioned conjugate gradients,
with fixed-point safeguards that make it globally convergent. It
typically needs about ten eigendecompositions at any $n$.
